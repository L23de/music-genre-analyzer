...
cat("Accuracy for train data:", accuracy) #0.3338327

# Predictions for test
vpred <- predict(decisionTree, data = test, type = "class")
tab <- table(pred = vpred, actual = test$genre) 
tab
accuracy <- sum(diag(tab))/sum(tab)
cat("Accuracy for test data:", accuracy) #0.3430837
```
